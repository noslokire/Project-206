<?php
// $Id: page.tpl.php,v 1.15 2009/04/28 16:30:38 jrglasgow Exp $;
?>
...
<body<?php print phptemplate_body_class($sidebar_left, $sidebar_right); ?>>
  ...
  <?php if (theme_get_setting('toggle_name') || theme_get_setting('toggle_slogan') || $header) { ?>
    ...
    <div id="footer">
      ...
      <?php } ?>
    <div style="color:gray"><strong>THEME DESIGN</strong> Copyright &#169; 2009 under <a href="http://www.gnu.org/licenses/gpl.html" target="_blank">GNU</a> by <a href="http://www.tributemedia.com" title="High Performing, Industry Specific Websites" target="_blank">Tribute Media</a>. Site Powered by <a href="http://drupal.org/">Drupal</a>.</div>
    </div><!-- /footer -->
  <div style="clear:both"></div>
